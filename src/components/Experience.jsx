    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="hidden sm:block absolute left-1/2 w-1 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 rounded-full animate-pulse opacity-30 z-0"
        />
        ...
        {experience.map((exp, idx) => (
          ...
          >
            {/* Glowing Dot */}
            <div className="hidden sm:block w-6 h-6 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 rounded-full absolute left-1/2 -translate-x-1/2 top-2 shadow-[0_0_20px_rgba(236,72,153,0.8)] animate-pulse"></div>

            {/* Experience Card */}
            <div className="bg-gray-800 text-left rounded-xl shadow-lg p-6 w-full sm:w-[45%] mx-4 border border-blue-500 transition duration-300 hover:scale-[1.03] hover:shadow-[0_0_25px_rgba(59,130,246,0.4)]">
