...
const Certifications = () => {
  ...
  return (
    <motion.section
      ...
      viewport={{ once: false, amount: 0.2 }} // animate on both scrolls
    >
      <motion.h2
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        />
        <motion.div
          className="hidden lg:block absolute left-[33.3%] top-0 h-full w-0.5 bg-gradient-to-b from-blue-500 via-blue-300 to-blue-500 animate-pulse opacity-20"
          initial={{ height: 0 }}
          animate={{ height: "100%" }}
          transition={{ duration: 1.8, ease: "easeInOut" }}
        />
        <motion.div
          className="hidden lg:block absolute left-[66.6%] top-0 h-full w-0.5 bg-gradient-to-b from-blue-500 via-blue-300 to-blue-500 animate-pulse opacity-20"
          initial={{ height: 0 }}
          animate={{ height: "100%" }}
        ...
        {certifications.map((cert, idx) => (
          <motion.div
            ...
            viewport={{ once: false, amount: 0.2 }} // animate again when visible
          >
