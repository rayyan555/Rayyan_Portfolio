    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {certifications.map((cert, idx) => (
          <motion.div
            key={idx}
            className="bg-gray-800 p-6 rounded-xl shadow-md text-left cursor-pointer"
            custom={idx}
            variants={flipInY}
      ...
      {selectedCert && (
        <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex justify-center items-center">
          <div className="relative bg-gray-900 p-4 rounded-lg max-w-[90vw] max-h-[90vh] overflow-auto">
            <button
