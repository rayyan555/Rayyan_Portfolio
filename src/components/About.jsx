...
const About = () => {
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-white text-center flex items-center justify-center gap-3">
          <UserCircle className="w-7 h-7 sm:w-8 sm:h-8 text-blue-500" />
          About Me
        </h2>
      ...
      >
        {[
          ...
          <motion.div
            ...
            className="bg-gray-800 p-4 sm:p-5 rounded-xl text-center shadow hover:shadow-blue-500/30 border border-blue-500 transition duration-300"
          >
